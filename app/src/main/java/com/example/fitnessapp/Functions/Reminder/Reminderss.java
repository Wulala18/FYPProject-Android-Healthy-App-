package com.example.fitnessapp.Functions.Reminder;
...
public class Reminderss extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reminderss);
        // Initialize reminder database
        rb = new ReminderDatabase(getApplicationContext());

        // Initialize views
        mToolbar = findViewById(R.id.r_toolbar);
       ...
       mToolbar.setNavigationOnClickListener(v -> startActivity(new Intent(getApplicationContext(), Home.class)));
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public  class VerticalItemHolder extends SwappingHolder implements View.OnClickListener, View.OnLongClickListener {
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = Reminderss.this;
