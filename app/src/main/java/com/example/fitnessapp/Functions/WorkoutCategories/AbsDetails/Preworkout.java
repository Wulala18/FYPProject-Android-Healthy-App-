...
public class Preworkout extends YouTubeBaseActivity implements  YouTubePlayer.OnInitializedListener,YouTubePlayer.PlaybackEventListener,YouTubePlayer.PlayerStateChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myoutube = findViewById(R.id.preworkoutabsvideo);
        myoutube.initialize(YoutubeConfigs.getApiKey(),this);


    }
    public void prework_btn(View view) {
