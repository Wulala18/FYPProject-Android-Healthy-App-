...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        int mReceivedID = Integer.parseInt(Objects.requireNonNull(intent.getStringExtra(ReminderEditActivity.EXTRA_REMINDER_ID)));
       ...
       Notification notification = mBuilder.setContentTitle("Ring Ring....")
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.fitnesslogo))
    ...
    public void setAlarm(Context context, Calendar calendar, int ID) {
        ...
        long diffTime = c.getTimeInMillis() - currentTime;
