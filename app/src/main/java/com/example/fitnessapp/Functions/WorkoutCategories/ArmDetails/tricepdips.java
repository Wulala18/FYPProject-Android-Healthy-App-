...
public class tricepdips extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener,YouTubePlayer.PlaybackEventListener,YouTubePlayer.PlayerStateChangeListener
{


    YouTubePlayerView myoutube;

    String VIDEO_ID ="6kALZikXxLc";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myoutube = findViewById(R.id.tricepdipsvideo);
    ...
    public void tricepdips_btn_arm(View view) {
