...
public class ReminderAddActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Views
        relativeLayout = findViewById(R.id.add_snackbar);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.discard_reminder:
                Snackbar.make(relativeLayout, "The Reminder has been Deleted", BaseTransientBottomBar.LENGTH_SHORT ).show();
                onBackPressed();
                return true;
